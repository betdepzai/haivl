...
function vscheck_get_video_status($args)
{
	...
	switch ( (int) $video['source_id'])
	{
		...
		case 3:	//	Youtube
			...
			{
				$display_message = "You need a Youtube API Key to check videos. For <strong><a href='https://www.youtube.com/watch?v=qXhIpThTMlk' target='_blank'>these step-by-step video instructions</a></strong> on how to create your API key.";
				break;
			}
