					...
					case 'youtube':
						...
						else
						{
							$api_data = array('error' => array('message' =>
								...
								For step-by-step instructions on how to create your API key, please <strong><a href="https://www.youtube.com/watch?v=qXhIpThTMlk" target="_blank">watch this video</a></strong>.'));
						}
	...
	case 'cron':
		...
		switch ($action)
		{
			...
			case 'add-job':
				...
				{
					$ajax_msg = 'BBBBBB Invalid token or session expired. Please refresh this page and try again.';
					exit(json_encode(array(	'success' => false, 
											'alert_type' => 'error',
											'msg' => $ajax_msg,
											'html' => pm_alert_error($ajax_msg))));
