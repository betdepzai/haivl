<?php /* Smarty version 2.6.20, created on 2016-02-18 09:00:02
...
">
			...
			<fieldset>
			    <div class="control-group">
			      ...
			      <div class="controls">
					<span class="btn-upload border-radius4" rel="tooltip" title="*.flv,*.mp4,*.wmv,*.mov,*.divx,*.avi,*.mkv, *.asf, *.wma, *.mp3, *.m4v, *.m4a, *.3gp, *.3g2<br /> Maximum: <?php echo $this->_tpl_vars['upload_limit']; ?>
