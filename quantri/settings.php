...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="table table-striped table-bordered pm-tables pm-tables-settings">
	  ...
	  <tr>
		  ...
		  <td><label><input name="gzip" type="radio" value="1" <?php echo ($config['gzip']==1) ? 'checked="checked"' : "";?> /> Enabled</label>
			<label><input name="gzip" type="radio" value="0" <?php echo ($config['gzip']==0) ? 'checked="checked"' : "";?> /> Disabled</label> <a href="#" rel="popover" data-placement="right" data-trigger="hover" data-content="If supported, gzip compression should improve page loading times."><i class="icon-info-sign"></i></a>
          </td>
	  </tr>
	  <tr>
	...
	<?php if ( empty($config['youtube_api_key']) ) : ?>
		<div class="alert alert-help">
			...
			<p>To import videos from YouTube.com, an API key is required. <strong><a href="https://www.youtube.com/watch?v=qXhIpThTMlk" target="_blank">Watch the video</a></strong> and see how to create your API key.</p>
