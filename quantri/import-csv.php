...
<div id="adminPrimary">
	...
	<div class="content">
		...
		<div class="row-fluid">
	        ...
	        <form id="import_csv_upload_file" enctype="multipart/form-data" action="import-csv.php?step=1" method="post" onsubmit="return false;">
		        <div class="pm-swf-upload">
		            <ol id="uploadCSVLog" class="list-unstyled"></ol>
		        </div>

		        <input type="text" name="selected-csv-filename" value="" id="" class="span5" disabled />
		        <span class="btn btn-mini btn-upload-widget">
		            <span id="uploadCSVButtonPlaceholder">Select &amp; Upload</span>
		        </span>
		        <span id="debugging-output-serverdata"></span>
		        <span class="importLoader"><img src="img/ico-loading.gif" width="16" height="16" /></span>
	        </form>
		</div><!-- .row-fluid --> 
				...
				<div class="pm-file-data">
					<div id="import-csv-ajax-response">
						<div class="alert alert-info">
							PHP Melody will attempt to gather information about each media file or video URL. Click &ldquo;<strong>Process entries</strong>&rdquo; to begin.
						</div>
					</div>
					...
					<div class="pm-file-action">
						...
						<br /><em class="importLoader animated infinite fadeIn"><small>Please wait...</small></em>
					</div>
				</div>
			<div class="clearfix"></div>
			</div>
