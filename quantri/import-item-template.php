<div class="video-stack<?php if ($_POST['checkall'] == 'true') echo ' stack-selected'; if ( ! $item['embeddable'] || $item['private']) echo ' stack-unusable';?>" id="stack-id-<?php echo str_replace(' ', '-', $counter); ?>">
	...
	<input id="video-title[<?php echo $counter;?>]" name="video_title[<?php echo $counter;?>]" type="text" value="<?php echo ucwords($item['title']); ?>" size="20" class="video-stack-title required_field" rel="tooltip" title="Click to edit" />
