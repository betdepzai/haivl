                  ...
                  <div class="nav-collapse">
                    <ul class="nav">
                      ...
                      <li class="dropdown">
                        ...
                        {else}
                        <a href="{$smarty.const._URL}/category.php" class="dropdown-toggle wide-nav-link disabled" data-target="#" role="button" data-toggle="dropdown">{$lang.category} <b class="caret"></b></a>
                        {/if}
